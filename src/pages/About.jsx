    ...
    <div className="flex flex-col items-center mx-auto w-full max-w-4xl p-5">
      ...
      <div className="card w-full bg-base-100 shadow-xl mt-8 text-base-content">
        <div className="card-body">
          ...
          <p>
            이 웹페이지는 React와 DaisyUI를 기반으로 만들어졌으며, 사용자 경험을
            극대화하기 위해 최신 프론트엔드 기술을 사용했습니다. 프론트엔드
            개발은 React 라이브러리를 사용하여 모듈화된 컴포넌트를 작성하였고,
            TailwindCSS와 DaisyUI를 사용하여 빠르고 일관된 UI 디자인을
            적용했습니다.
          </p>
          <p>
            백엔드는 Django로 구축되었으며, 데이터베이스는 MongoDB를
